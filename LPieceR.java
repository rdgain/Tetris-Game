...
public class LPieceR extends Piece {

    /**
     * constructor. invokes the constructor of the superclass
     * @param c - the piece color
     */
    public LPieceR(int c) {
        super(6,c);

        this.createShape();
        this.changeCoordinates(xI, 1);
        this.setCoordinates();
    ...
    public boolean changeDirection(int d) {
        ...
        direction = d;
        switch (d) {
            case 0 : newX = pieceShape[0].getX()-2; newY = pieceShape[0].getY(); break;
            case 1 : newX = pieceShape[0].getX(); newY = pieceShape[0].getY()-2; break;
            case 2 : newX = pieceShape[0].getX()+2; newY = pieceShape[0].getY(); break;
            case 3 : newX = pieceShape[0].getX(); newY = pieceShape[0].getY()+2; break;
        }
