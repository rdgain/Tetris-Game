...
public class ZPieceR extends Piece {

    /**
     * constructor. invokes the constructor of the superclass
     * @param c - the piece color
     */
    public ZPieceR(int c) {
        super(7, c);

        this.createShape();
        this.changeCoordinates(6, yI);
        this.setCoordinates();
    ...
    public boolean changeDirection(int d) {
        ...
        direction = d;
        switch (d) {
            case 0 : newX = pieceShape[0].getX()+1; newY = pieceShape[0].getY()+1; break;
            case 1 : newX = pieceShape[0].getX()-1; newY = pieceShape[0].getY()+1; break;
            case 2 : newX = pieceShape[0].getX()-1; newY = pieceShape[0].getY()-1; break;
            case 3 : newX = pieceShape[0].getX()+1; newY = pieceShape[0].getY()-1; break;
        }
